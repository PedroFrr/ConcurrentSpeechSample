...
import com.example.multipleaudioplayer.databinding.LayoutSpatializationExampleFirstNewsBinding
...
class SpatializationFirstNewsExampleFragment :
    Fragment(R.layout.layout_spatialization_example_first_news) {

    private val binding by viewBinding(LayoutSpatializationExampleFirstNewsBinding::bind)
    ...
    companion object {
        private const val FIRST_COLUMN =
            "scenario_spatialization_first_news_first_column_cristiano.mp3"
        private const val SECOND_COLUMN =
            "scenario_spatialization_first_news_second_column_ines.mp3"
    }
}